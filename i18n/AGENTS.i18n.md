...
Este arquivo é o ponto de composição das normas de internacionalização de mensagens.

Antes de analisar, revisar, planejar ou modificar bundles, chaves ou resolvers de mensagens, leia também:
